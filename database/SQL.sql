...
BEGIN
	...
	INSERT INTO POSTS(AUTHOR,TITLE,COMMENT,MEDIATYPE,MEDIADATA,MEDIAFILENAME,POSTDATETIME, LATITUDE, LONGITUDE, IS_EXCLUSIVE, AREA_METERS, DATETIME_AVAILABILITY)
	SELECT @AUTHOR, JJ.title, JJ.comment, JJ.mediatype, JJ.media_b64,JJ.mediafilename,GETDATE(), JJ.latitude ,JJ.longitude ,
	JJ.IS_EXCLUSIVE, JJ.AREA_METERS, CONVERT(DATETIME,JJ.DATETIME_AVAILABILITY,126)
