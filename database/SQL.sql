USE [master]
GO
/****** Object:  Database [GEOMEDIA]    Script Date: 19/05/2025 17:35:35 ******/
...
USE [GEOMEDIA]
GO
/****** Object:  Table [dbo].[POSTS]    Script Date: 19/05/2025 17:35:35 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[POSTS](
	...
	[AREA_KM] [int] NULL,
	[DATETIME_AVAILABILITY] [datetime] NULL,
...
GO
/****** Object:  Table [dbo].[USERS]    Script Date: 19/05/2025 17:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[DELETEPOST]    Script Date: 19/05/2025 17:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[DOLOGIN]    Script Date: 19/05/2025 17:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GETMEDIAPOST]    Script Date: 19/05/2025 17:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GETPOSTS]    Script Date: 19/05/2025 17:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	BEGIN
		SELECT  ID, AUTHOR, TITLE, COMMENT, MEDIATYPE, POSTDATETIME, LATITUDE, LONGITUDE, MEDIAFILENAME, IS_EXCLUSIVE, AREA_KM FROM POSTS
...
GO
/****** Object:  StoredProcedure [dbo].[NEWPOST]    Script Date: 19/05/2025 17:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	INSERT INTO POSTS(AUTHOR,TITLE,COMMENT,MEDIATYPE,MEDIADATA,MEDIAFILENAME,POSTDATETIME, LATITUDE, LONGITUDE, IS_EXCLUSIVE, AREA_KM, DATETIME_AVAILABILITY)
	SELECT @AUTHOR, JJ.title, JJ.comment, JJ.mediatype, JJ.media_b64,JJ.mediafilename,GETDATE(), JJ.latitude ,JJ.longitude ,
	JJ.IS_EXCLUSIVE, JJ.AREA_KM, CONVERT(DATETIME,JJ.DATETIME_AVAILABILITY,126)
	FROM OPENJSON(@POSTCONTENT,'$') WITH(
		...
		IS_EXCLUSIVE BIT,
		AREA_KM INT,
		DATETIME_AVAILABILITY VARCHAR(100)
	) JJ
	SELECT 1 AS ESITO
