...
Instead, users can choose a maximum distance within the marker will be visible by others, like creating a circular area around it visible only if the current user's location is included.
...
This feature gives live to several use cases, for example GeoMedia could be also used to create interactive experiences and games such as: ``scavenger hunt" or ``hide and seek" games.
