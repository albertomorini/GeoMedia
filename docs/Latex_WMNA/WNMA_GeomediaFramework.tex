...
\begin{minipage}{.2\textwidth}
    \subfloat{\fbox{\includegraphics[width=\textwidth,height=7.7cm]{imgs/Screenshots/Padua1.png}}}\label{fig:sub_a}}
\end{minipage}
\hfill
\begin{minipage}{.2\textwidth}
    \subfloat{\fbox{\includegraphics[width=\textwidth,height=7.7cm]{imgs/Screenshots/Padua2.png}}}\label{fig:sub_b}}
\end{minipage}
    \caption{Implementation of the use case for the City of Padua}\label{fig:sub}
\end{figure}
...
In fact, the adopted three-tier architecture shown in Figure 2, makes the app work as desired.
\\
...
\begin{figure}[htbp]
\begin{center}
\fbox{{\includegraphics[width=4.8cm, height=9.5cm\textwidth]{imgs/Screenshots/UserProfile.png}}}
\end{center}
...
The results rendered by the Map component can be seen in Figure 4, where in the left scenario two cities are included, useful case to cover wider area such rural landscapes; instead, in the right image, there's a more detailed scenario that enrich the center of a town by marking interesting attraction points with photos and comments.
...
In fact, a user, when creating a new post (as shown in the left picture of Figure 5) can choose to make it temporized by selecting an expiration date and time (as can be seen in the right picture of Figure 5); or geographically limiting it's visibility by inserting the kilometers within the users need to be in order to view it.

\begin{figure}
\begin{minipage}{.2\textwidth}
    \subfloat{\includegraphics[width=\textwidth]{imgs/Screenshots/Pubblicazione.png}}\label{fig:sub_a}}
\end{minipage}
\begin{minipage}{.2\textwidth}
    \subfloat{\fbox{\includegraphics[width=\textwidth]{imgs/Screenshots/DataOra.png}}}\label{fig:sub_b}}
\end{minipage}
    \caption{User interfaces for post creation and temporized selection}\label{fig:sub}
\end{figure}



An exclusive post by date will be visible from the moment it has been posted to the time indicated. \\
Moreover, users can choose a maximum distance within the marker will be visible by others, like creating a circular area around it, visible only if the user's current location is included.

As explained before, limited content are represented by green markers, in fact, Figure 6 compared to the right Figure 4, proves the correctly of GeoMedia by retrieving a post limited by area when the user (blue marker) is near.

\begin{figure}[htbp]
\begin{center}
{\includegraphics[width=4.8cm, height=9.5cm\textwidth]{imgs/Screenshots/CentroExclusive.png}}
\end{center}
\caption{Retrieving of limited content by location.}
\label{fig}
\end{figure}


This feature gives live to several use cases, for example GeoMedia could be also used to create interactive experiences and games such as: ``scavenger hunt" or ``hide and seek".
...
\begin{figure}[htbp]
\begin{left}
\fbox{{\includegraphics[width=8.5cm, height=5cm\textwidth]{imgs/microservices.png}}}
\end{lef}
...
\begin{itemize}
    ...
    \item `POSTS' for posts with all relative attributes and metadata
\end{itemize}
...
\bibitem{BreakTheInternet} The Break the Internet effect. 
\\
https://dictionary.cambridge.org/dictionary/english/break-the-internet
\bibitem{WANET} WANET (Wireless ad hoc Network) explained.
